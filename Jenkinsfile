    ...
    stages {
        ...
        stage('deploy') {
            steps {
                ...
                sh "scp /home/slave/workspace/Parcel_Service_feature-2/target/simple-parcel-service-app-1.0-SNAPSHOT.jar root@172.31.46.201:/opt/apache-tomcat-8.5.98/webapps/"
            }
        }
